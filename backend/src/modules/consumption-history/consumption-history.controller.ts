...
export class ConsumptionHistoryController {
  ...
  create(@Body() dto: CreateConsumptionHistoryDto, @User() user: JwtUser) {
  ...
  findAll(@User() user: JwtUser) {
    return this.consumptionService.findAll(user);
  }
  ...
  findOne(@Param('id') id: string, @User() user: JwtUser) {
    return this.consumptionService.findOne(+id, user);
  }
  ...
  update(@Param('id') id: string, @Body() dto: UpdateConsumptionHistoryDto, @User() user: JwtUser) {
    return this.consumptionService.update(+id, dto, user);
  }
  ...
  remove(@Param('id') id: string, @User() user: JwtUser) {
    return this.consumptionService.remove(+id, user);
  }
  ...
  logConsumption(@Body() dto: CreateConsumptionHistoryDto, @User() user: JwtUser) {
    return this.consumptionService.logConsumption(dto, user);
  }
  ...
  monthlyStatisticsUser(
    @Query('year') year: string,
    @Query('userId') userId: string,
    @User() user: JwtUser,
  ) {
    return this.consumptionService.monthlyStatisticsUser(+year, +userId, user);
  }
  ...
  topConsumedUser(
    ...
    return this.consumptionService.topConsumedUser(type, limitNumber, user, userIdNumber);
  }
  ...
  monthlyStatisticsFamily(
    @Query('year') year: string,
    @Query('familyId') familyId: string,
    @User() user: JwtUser,
  ) {
    return this.consumptionService.monthlyStatisticsFamily(
      Number(year),
      Number(familyId),
      user,
    );
  ...
  topConsumedFamily(
    ...
    return this.consumptionService.topConsumedFamily(
      type,
      limitNumber,
      user,
      familyIdNumber,
