  ...
  async removeMember(id: number, user: JwtUser) {
    ...
    try {
      ...
      for (const memberItem of remainingMembers) {
        ...
        console.log(`[removeMember] Notification created successfully for user ${memberItem.user_id}`);
      }
  ...
  async removeMemberById(id: number) {
    ...
    try {
      ...
      for (const memberItem of remainingMembers) {
        ...
        console.log(`[removeMemberById] Notification created successfully for user ${memberItem.user_id}`);
      }
