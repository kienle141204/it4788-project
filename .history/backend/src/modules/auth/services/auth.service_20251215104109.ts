...
export class AuthService {
  ...
  async verifyOtp(verifyOtpDto: VerifyOtpDto): Promise<{ message: string; access_token: string; refresh_token: string; user: Partial<User> }> {
    ...
    return {
      message: ResponseMessageVi[ResponseCode.C00058],
      access_token,
      refresh_token,
  ...
  async registerUserInfo(registerUserInfoDto: RegisterUserInfoDto, userId: number): Promise<{
    ...
    return {
      message: ResponseMessageVi[ResponseCode.C00086],
  ...
  async login(loginDto: LoginDto): Promise<{
    ...
    return {
      message: ResponseMessageVi[ResponseCode.C00047],
      access_token,
      refresh_token,
      user: userWithoutPassword,
    };
  ...
  async refreshToken(refreshTokenDto: RefreshTokenDto): Promise<{
    ...
    try {
      ...
      return {
        message: ResponseMessageVi[ResponseCode.C00065],
  ...
  async logout(userId: number): Promise<{ message: string }> {
    ...
    return { message: ResponseMessageVi[ResponseCode.C00050] };
  }
