...
export class DishController {
  ...
  async findAll() {
    ...
    return buildSuccessResponse(ResponseCode.C00102, dishes);
  }
  ...
  async findAllWithPagination(@Query() paginationDto: PaginationDto) {
    ...
    return buildSuccessResponse(ResponseCode.C00102, result.data, {
      pagination: {
  ...
  async searchByNameWithPagination(@Query() searchDto: SearchDishDto) {
    ...
    return buildSuccessResponse(ResponseCode.C00104, result.data, {
  ...
  async findOne(@Param('id', ParseIntPipe) id: number) {
    ...
    return buildSuccessResponse(ResponseCode.C00103, dish);
  }
  ...
  async create(@Body() createDishDto: CreateDishDto, @Request() req) {
    ...
    return buildSuccessResponse(ResponseCode.C00101, dish);
  }
  ...
  async getDishNutrients(@Param('id', ParseIntPipe) id: number) {
    ...
    return buildSuccessResponse(ResponseCode.C00107, {
      dish: {
        id: dish.id,
        name: dish.name,
      },
  ...
  async getTopRatedDishes(
    ...
    return buildSuccessResponse(ResponseCode.C00105, dishes, {
      filters: {
        top,
        minRating,
        month: targetMonth,
  ...
  async getTopMenuDishes(
    ...
    return buildSuccessResponse(ResponseCode.C00106, dishes, {
      filters: {
        top,
        month: targetMonth,
        year: targetYear,
