...
export class DishReviewController {
  ...
  async createReview(
    ...
    return buildSuccessResponse(ResponseCode.C00151, review);
  }
  ...
  async updateReview(
    ...
    return buildSuccessResponse(ResponseCode.C00154, review);
  }
  ...
  async deleteReview(
    ...
    return buildSuccessResponse(ResponseCode.C00155);
  }
}
